...
# ... (add other edges as per your graph)
labels = ["A", "B", "A", "C", "D", "D", "C", "C", "B", "A"]


# BFS version! This works!
function find_all_subgraphs(g::SimpleGraph, start_node::Int, N::Int)
...
# struct SubgraphIterator
    
# end

# function iterate_all_subgraphs(g::SimpleGraph, start_node::Int, N::Int)
#     all_subgraphs = Set{Vector{Int}}()  # Using a Set to ensure uniqueness
...
@btime find_all_subgraphs(g, start_node, N)